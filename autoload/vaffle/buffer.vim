...
function! s:set_up_default_mappings() abort
  ...
  call s:map_default('n', '-',        'open-selected-split',  '<buffer> <silent>')
  call s:map_default('n', '<Bslash>', 'open-selected-vsplit', '<buffer> <silent>')
  call s:map_default('n', '\|',       'open-selected-vsplit', '<buffer> <silent>')
  call s:map_default('n', '<CR>',     'open-selected',        '<buffer> <silent>')
